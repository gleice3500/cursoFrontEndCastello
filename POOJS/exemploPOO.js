...
class Produto {
    //atributos
    //não precisei declarar, JS criar automaticamente a partir do construtor
    //construtor
...
let pessoa2 = new Pessoa("João", 30, "987.654.321-00");
pessoa1.exibirInfo();
pessoa2.exibirInfo();
//altera a idade de pessoa1
pessoa1.setIdade=26;
pessoa1.exibirInfo();
...
//instanciar os objetos da Class Funcionário
